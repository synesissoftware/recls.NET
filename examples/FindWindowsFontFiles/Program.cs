...
namespace FindWindowsFontFiles
{
	...
	class Program
	{
		static void Main(string[] argv)
		{
			...
			foreach(IEntry entry in FileSearcher.Search(@"C:\windows", "*.fon|*.ttf|*.otf", SearchOptions.None, FileSearcher.UnrestrictedDepth, null, delegate(object context, string path, Exception x) {
